...
> gulp watch
---
**Сборка поддерживает проверки** 
> npm run test - проверяет стилистику написания кода, его форматирование.

> npm run bem - проверяет разметку на правильность нейминга BEM.
